...
class MessageWriter implements Runnable {
    ...
    private MessageRepository outgoingMessages;
    ...
    public MessageWriter(MessageRepository outgoingMessages) {
    ...
    public void run() {
        ...
        for(int i =0; i< lines.length; i++){
            outgoingMessages.write(lines[i]);
            try {
...
class MessageReader implements Runnable {
    ...
    public MessageReader(MessageRepository outgoingMessages) {
        this.incomingMessage = outgoingMessages;
    }
